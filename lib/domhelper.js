...
export const map = function(
        ...
        if(container.length===1){
            ...
            [ list, hookContainer ] = toNodeList(container);
            //FIXME: list._$hookcontainer kann innerhalb nodlist erfolgen
            //FIXME: toNodeList kann nur eine liste zurückliefern
            list._$hookcontainer = hookContainer;
        } else {
            var fragment = document.createDocumentFragment();
            list = fragment.querySelectorAll('*');
        }
        return list;
};

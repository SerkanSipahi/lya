...
/**
 * [virutalHookContainer description]
 * @type {[type]}
 */
export var $$virutalHookContainer = null;
...
export const map = function(
        ...
        $$virutalHookContainer = hookContainer;

        return docFragment.childNodes;
 ...
 * @return {[type]} [description]
 */
export const toNodeList = function(list : NodeList){

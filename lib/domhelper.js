...
export var each = (domCollection=null, callback=null, context='') => {
    ...
    if(!(domCollection instanceof NodeList) || !(domCollection instanceof HTMLCollection)) {
        throw new NotInstanceOfError();
    }
 ...
 * @return {[type]}      [description]
 */
export var css = (dom, arg1=null, arg2=null, arg3=null) => {

    if(!(domCollection instanceof HTMLElement)) {
        throw new NotInstanceOfError();
    }

 ...
 * @return {[type]}      [description]
 */
var getStyle = (node : HTMLElement, prop : string) : string => {
 ...
 * @return {[type]}               [description]
 */
var writeCssObject = (node : HTMLElement, collection : object) : void => {

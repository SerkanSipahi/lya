...
import * as utility from 'lyadom/lib/utility';
import from 'lyadom/lib/polyfills';

/**
 * [isTypeof description]
 * @type {Boolean}
 */
var isTypeof = utility.isTypeof;

/**
 * Note: move this to utilities
 * [native injector]
 * @type {[type]}
 */
Function.prototype.$inject = function(arg = {}) {
  
    var isTypeof = (object, type) => {
        {}.toString.call(object).toLowerCase() === '[object '+type+']'.toLowerCase();    
    };
...
const qSelector = doc.querySelectorAll.bind(doc);

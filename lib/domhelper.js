...
/**
 * [description]
 * @link   {[https://developer.mozilla.org/de/docs/Web/JavaScript/Reference/Statements/for...in]}
 * @param  {[type]}   dom      [description]
 * @param  {Function} callback [description]
 * @param  {[type]}   context  [description]
 * @return {[type]}            [description]
 */
export var each = (nodes : HTMLCollection | NodeList, callback : function, context : string) : HTMLCollection | NodeList => {

    for(var dom in domCollection) {
 ...
 * @return {[type]}      [description]
 */
export var css = (dom : HTMLElement, arg1 : string, arg2 : string | int | float, arg3 : function) : HTMLElement => {
 ...
 * @return {[type]}      [description]
 */
var getStyle = (dom : HTMLElement, prop : string) : string => {
 ...
 * @return {[type]}               [description]
 */
var writeCssObject = (dom : HTMLElement, collection : object) : void => {
